...
lastReviewedNote: 'Reviewed for Issue #232: 记录 identity getter fail-close、worker drain、FIFO/min-heap 调度、锁 ownership 与 timer 上限；不新增依赖或发布路径。'
related:
  - AGENTS.md
  - .docpact/config.yaml
  - README.md
