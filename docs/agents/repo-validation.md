...
lastReviewedNote: 'Reviewed for Issue #230: 0.1.1 proof pins Node 24.19.0 and test-locks exact platform, cryptographic Sigstore/registry, isolated pnpm, dependency-scan, and continuation-owned integration gates.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
