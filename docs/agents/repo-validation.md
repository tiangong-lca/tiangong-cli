...
lastReviewedNote: 'Reviewed for Issue #244: OAuth proof covers exact PKCE forms, fixed loopback callback, shell-free browser launch, private atomic refresh rotation, OAuth-only failure, explicit headless access tokens, legacy compatibility, and unchanged 100%/package gates.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
