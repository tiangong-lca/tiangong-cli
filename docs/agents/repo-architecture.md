...
lastReviewedNote: 'Reviewed for Issue #232: records guarded identity drift, drained workers, FIFO/min-heap scheduling, internal lock ownership, timers, dogfood, and closed package boundaries at 0.1.1.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
