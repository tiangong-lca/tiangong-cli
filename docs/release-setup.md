...
lastReviewedNote: 'Reviewed for CLI #284: public topic overview adds read-only dataset commands without changing release versions, dependencies, bootstrap or publication workflows. Existing package, exact-coverage, provenance and release qualification gates still apply.'
related:
  - ../AGENTS.md
  - ../.docpact/config.yaml
  - ./release-runbook.md
