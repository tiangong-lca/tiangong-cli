...
lastReviewedNote: 'Reviewed for CLI #304: the structured lifecyclemodel failure fix and database-engine capability migration do not change package identity, release commands, workflows, tag policy, or Trusted Publishing requirements.'
related:
  - ../AGENTS.md
  - ../.docpact/config.yaml
  - ./release-setup.md
