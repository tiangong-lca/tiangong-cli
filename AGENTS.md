...
lastReviewedNote: 'Reviewed for Issue #230: 0.1.1 uses exact Node 24.19.0 across local/CI metadata, exact-platform gates, cryptographic Sigstore and registry proof, isolated pnpm consumers, and finish-first integration.'
related:
  - .docpact/config.yaml
