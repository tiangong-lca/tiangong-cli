...
- Direct dependency baseline: Supabase JS `2.112.4`, TIDAS SDK `0.2.0`, lint-staged `17.4.1`, Prettier `3.9.6`, and tsx `4.23.13`; `@types/node 24.13.3` is the latest compatible Node 24 line. `pnpm peers check` must pass before package and coverage proof.
