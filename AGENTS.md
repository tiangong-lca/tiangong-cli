...
lastReviewedNote: 'Reviewed for Issue #232: guarded identity drift, in-flight drainage, FIFO/min-heap scheduling, lock ownership, timer bounds, dogfood, and declarations are documented at version 0.1.1.'
related:
  - .docpact/config.yaml
