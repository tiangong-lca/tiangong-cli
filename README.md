...
lastReviewedNote: 'Reviewed for Issue #230: identifies 0.1.1 as the public auth-receipt release and records its reusable four-platform pre-tag and public pnpm verification contract.'
---
...
Review note, 2026-08-25: Issue #230 publishes the merged identity receipt as `@tiangong-lca/cli@0.1.1`. Runtime behavior, direct dependencies, the pnpm lock, and the Node 24 / pnpm 11.23.0 / TypeScript 7.0.2 / Oxlint baseline remain unchanged. Release automation now makes the reusable four-platform pnpm matrix a pre-tag dependency and provides `pnpm release:verify-published` for public provenance, actual tarball integrity, and credential-free pnpm bin/ESM/CJS consumer proof.
