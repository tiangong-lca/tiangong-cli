...
lastReviewedNote: 'Reviewed for Issue #232: documents guarded identity drift, drained workers, FIFO/min-heap scheduling, lock/timer safety, the closed package root, and deferred release.'
---
