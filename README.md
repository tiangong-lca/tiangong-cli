...
- `@tiangong-lca/cli/runtime` (introduced by #274, pending C1 publication) describes CLI package, asset and Node content and compares them against independently trusted exact expectations. It does not authenticate or attest a complete production dependency component.
