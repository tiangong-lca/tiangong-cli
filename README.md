...
lastReviewedNote: 'Reviewed for Issue #230: identifies 0.1.1 as the public auth-receipt release and records exact-platform pre-tag plus cryptographic Sigstore/isolated pnpm verification.'
---
